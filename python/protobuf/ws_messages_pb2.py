...
PbWorkflow = _reflection.GeneratedProtocolMessageType('PbWorkflow', (_message.Message,), dict(
  ...
  StateTotalsEntry = _reflection.GeneratedProtocolMessageType('StateTotalsEntry', (_message.Message,), dict(
...
_PBWORKFLOW_STATETOTALSENTRY.has_options = True
_PBWORKFLOW_STATETOTALSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
